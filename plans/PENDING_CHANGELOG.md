...
- [lane A] [plugin] Widget-completion wave G (0.9.0): early component-level returns (verbatim-emit+splice, UETKX3007 top-level-final rule) + short-circuit `&&`/`||` desugar (UETKX3002 retired) — TD-015 gaps 1+4a closed; contract goldens + fileScan corpus both impls + compiled GrammarProof + ReactiveUI.Uetkx.WaveG (battery 127) (plan/widget-completion)
- [lane C] [community] Wave G/0.9.0: early returns + short-circuit rendering in .uetkx, grammar caught up with the family (plan/widget-completion)
