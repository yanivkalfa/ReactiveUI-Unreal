...
- **The launcher can GUT other engine installs** (5.8 catch-up): installing 5.8 reduced the
  verified UE_5.7 to a 343MB husk; the diff script then silently produced "+127 widgets
  added" against the empty side. The script now hard-fails on a <50-widget scan
